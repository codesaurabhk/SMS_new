  ...
  return (
    <div className="flex flex-col gap-2.5">
      <div className="flex items-center gap-2 text-[24px] text-[#696969] font-semibold">
        <Link to="/salary-structure" className="flex items-center gap-2">
          <IoChevronBack />
          <span>Back</span>
        </Link>
      </div>
      ...
      <div className="mt-6 p-6 rounded-2xl bg-white shadow-2xl">
        <div className="flex flex-col gap-0.5">
          ...
          <span className="text-[#9C9C9C] text-[16px] font-normal">
            Organize Salary by department or category
          </span>
        </div>
        <div className="grid lg:grid-cols-2 md:grid-cols-2 sm:grid-cols-1 gap-4">
          ...
          <div className="flex flex-col gap-2.5 mt-4">
            ...
            <input
              type="text"
              id="concession"
              placeholder="Tell something about allowance head"
              className="border border-[#E6E6E6] rounded-xl px-3 py-4"
            />
          </div>
        </div>
          ...
          <table className="w-full">
            ...
            <tbody>
              <tr className=" hover:bg-[#F9FAFC]">
                ...
                <td className="px-4 py-3 text-left font-Semibold text-[#1c1c1c] text-[14px]">
                  HRA
                </td>
                <td className="px-4 py-3 text-left font-normal text-[#1c1c1c] text-[14px]">
                  -
