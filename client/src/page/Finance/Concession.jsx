...
import aquaman from "../../assets/images/aquaman.jpg";
...
function Concession() {
  ...
  const concessionTypeOverview = [
    {
      id: 1,
      header: "Financial Hardship",
      students: "552",
      totalAmount: "180k",
      avg: "18",
      bg: "bg-[#FADFDF]",
  ...
  return (
    <div className="">
      ...
      {/* <---------------------------- Second table C-Application ----------------------------> */}

      <div className="bg-white mt-4 p-4 rounded-lg shadow-lg">
        <div>
          <p className="flex flex-col">
            <span className="text-[16px] md:text-[18px] text-[#1c1c1c] font-semibold">
              Consession Applications
            </span>
          </p>
        </div>
        ...
        <div className="mt-4 border border-[#e6e6e6] rounded-lg">
          <table className="w-full">
            ...
            <tbody>
              {concessionApplication.map((item, index) => (
                <tr key={index} className="border-b border-[#e6e6e6]">
                  <td className="px-4 py-3 text-left font-normal text-[#12516E] text-[14px] w-[25%]">
                    <div className="flex gap-4">
                      <div className="w-10 h-10 rounded-full overflow-hidden">
                        <img
                          src={item.img}
                  ...
                  <td className="px-4 py-3 text-left font-normal text-[14px] flex gap-2 items-center">
                    <span className=" text-[#009638] p-0.5">
                      <LiaCheckCircleSolid size={19} />
                    </span>
                    <span className="text-[#DC2626] p-0.5">
      ...
      <div className="bg-white mt-4 p-4 rounded-lg shadow-lg">
        <div>
          <p className="flex flex-col">
            <span className="text-[16px] md:text-[18px] text-[#1c1c1c] font-semibold">
              Consession Types Overview
            </span>
          </p>
        </div>

        <div className="grid lg:grid-cols-3 md:grid-cols-2 sm:grid-cols-2 gap-4">
          {concessionTypeOverview.map((item) => (
          <div key={item.id} className="mt-2 border border-[#E6E6E6] p-4 gap-2.5 rounded-xl">
            <div className="w-full">
              <span className={`${item.bg} ${item.color} rounded-xl flex items-center justify-center p-2 w-fit`}>
                <MdPercent size={24} />
              </span>
            </div>
            <div className="flex flex-col gap-1">
              ...
              <div className="flex flex-col gap-1">
                <div className="flex justify-between items-center">
                  <span className="text-[#696969] text-[15px] text-normal">
                    Students
                  </span>
